...
class SelfHarm extends Generator {

  static file = path.join(__dirname, '../xls/selfHarm.xls');
  static output = 'selfHarm.json';
  static title = '蓄意自我傷害';

  constructor() {
    super(SelfHarm.file, SelfHarm.title, SelfHarm.output);
    this.generate();
  }
